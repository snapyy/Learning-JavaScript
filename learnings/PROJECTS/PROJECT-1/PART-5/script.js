...
class Raven{
    constructor(){
        ...
        this.spriteHeight=194;const canvas=document.getElementById('canvas1');
const ctx=canvas.getContext('2d');
canvas.width=window.innerWidth;
canvas.height=window.innerHeight;
...
const pc=detectPixelColor.date;
ravens.forEach(object=>{
    if(object.randomColors[0]===pc[0] && object.randomColors[1]===pc[1] && object.randomColors[2]===pc[0]){
        //collisionDetected
