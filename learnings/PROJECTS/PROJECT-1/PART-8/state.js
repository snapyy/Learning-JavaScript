...
export class StandingLeft extends State{
    constructor(player){
        // we can use SUPER keyword in child classes to acess and call methods on objects's parent 
        super('STANDING LEFT');
        this.player=player;
    }
    enter(){
...
export class StandingRight extends State{
    ...
    // Ploymorphism :-  Allows methods to display different behaviour depending on which class calls it.
    enter(){
...
export class FallingRight extends State  {
    ...
    handleInput(input){
        if(input == 'PRESS left ')this.player.setState(states.FALLING_RIGHT);
        else if(this.player.onGround())this.player.setState(states.STANDING_RIGHT);
    }
}
